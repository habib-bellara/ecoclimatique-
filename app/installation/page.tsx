...
import { Check, Home, Users, Leaf, Globe, Phone, ChevronDown, Menu } from "lucide-react"
          ...
          <Card className="bg-white/90 backdrop-blur-sm shadow-2xl rounded-3xl border-0">
            <CardHeader className="text-center p-8">
              ...
              <CardDescription className="text-lg text-gray-600 mt-2 max-w-2xl mx-auto">
                Remplissez ce formulaire pour obtenir une estimation personnalisée pour votre projet d'installation.
              </CardDescription>
            </CardHeader>
              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                <div className="space-y-6 border-b pb-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <Label htmlFor="installationType" className="font-medium text-gray-700">Type d'installation</Label>
                      <Select
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="Mono-split">Mono-split</SelectItem>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <Label htmlFor="currentSystem" className="font-medium text-gray-700">Système actuel</Label>
                      <Input
                        id="currentSystem"
                        name="currentSystem"
                        placeholder="Ex: Radiateurs électriques"
                        className="mt-2 h-12"
                ...
                <div className="pt-6">
                  ...
                  {success && (
                    <p className="text-center text-green-700 font-semibold mt-4">
                      Merci ! Votre demande d'installation a été envoyée. Nous vous contacterons bientôt.
                    </p>
                  )}
