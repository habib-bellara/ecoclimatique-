...
export default function MaintenancePage() {
  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-green-100 overflow-x-hidden">
      <DecorativeBg />
      ...
      <main className="flex-grow py-16 px-2 md:px-8">
        <div className="relative z-10 max-w-5xl mx-auto bg-white/95 rounded-3xl shadow-2xl p-6 md:p-14 w-full transition-all duration-300 hover:shadow-3xl hover:scale-[1.01]">
          ...
          <p className="mb-6 text-lg text-gray-700 text-center">
            Nos programmes de maintenance garantissent la performance, la fiabilité et la longévité de vos systèmes de climatisation et de ventilation. Nous proposons des inspections régulières, des optimisations et un support 24/7 pour assurer un fonctionnement optimal toute l'année.
          </p>
          <div className="flex flex-col md:flex-row gap-6 mb-6 justify-center items-center">
            <div className="overflow-hidden rounded-2xl w-full md:w-1/2 group">
              <img src="https://www.praxedo.fr/wp-content/uploads/2022/09/reglementation-maintenance-climatisation-praxedo.png" alt="Maintenance Climatisation" className="rounded-2xl object-cover w-full h-[28rem] group-hover:scale-105 transition-transform duration-300" />
            </div>
          </div>
          <ul className="list-disc pl-6 mb-6 text-gray-700">
            <li><b>Inspections régulières</b> pour anticiper tout dysfonctionnement</li>
            <li><b>Optimisation des performances</b> pour réduire la consommation d'énergie</li>
            <li><b>Support technique 24/7</b> pour une tranquillité d'esprit totale</li>
          </ul>
