      ...
      <main className="flex-grow py-16 px-2 md:px-8">
        <div className="relative z-10 max-w-5xl mx-auto bg-white/95 rounded-3xl shadow-2xl p-6 md:p-14 w-full transition-all duration-300 hover:shadow-3xl hover:scale-[1.01]">
          ...
          <p className="mb-6 text-lg text-gray-700 text-center">
            Nos systèmes de contrôle intelligent permettent une gestion optimale de votre climatisation grâce à l'IA, la connectivité et la surveillance à distance. Profitez d'un confort sur-mesure et d'économies d'énergie.
          </p>
          ...
          <ul className="list-disc pl-6 mb-6 text-gray-700">
            <li><b>Optimisation IA</b> pour un réglage automatique selon vos habitudes</li>
            <li><b>Contrôle à distance</b> via smartphone ou tablette</li>
            <li><b>Analyses énergétiques</b> pour suivre et réduire votre consommation</li>
          </ul>
          <div className="text-center mt-8">
            <button type="button" className="bg-gradient-to-r from-green-600 via-teal-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white px-10 py-5 text-xl font-bold rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 flex items-center gap-3 mx-auto">
              ...
              Découvrir les contrôles intelligents
            </button>
          </div>
        </div>
      </main>
